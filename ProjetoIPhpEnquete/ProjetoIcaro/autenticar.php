...
<?php
   ...
   $sqlAluno = mysql_query("SELECT * FROM aluno WHERE id_matricula = '$matricula' and senha = '$senha'");
   $sqlProfessor = mysql_query("SELECT * FROM professor WHERE id_matricula = '$matricula' and senha = '$senha'");
